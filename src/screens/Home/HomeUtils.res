  ...
  let make = () => {
    ...
    <div className="mb-5 flex gap-4">
      <ContentSaidbar
        username1="Jain"
        username2="Jean R.S."
        username3="John Lennon"
        username4="John Malkovich"
        title1="Tipo de persona"
        title2="Tipo de persona"
        number="2"
        tabname="keos"
      />
      <Contentarea
        title1="Details"
        title2="testsuiiitint"
        inner="hello"
        content="dev"
        errortext="Errors"
        errormessage="Error formato de documento"
        details="Details"
        chat="Chat"
        security="Security"
        solicitar="Solicitar nuevos  envios"
        negar="Negar"
        passport="Details passport"
        lastname="Apellido"
        firstname="Segundo nombre"
        thardname="Primer nombre"
        number="Numero de cel"
        maile="Correo"
        birthdate="Facha de nacimiento"
        birthplace="Lugarde nacimiento"
        sandmaile="Send"
        information="Informacion de pasaporte"
        tipo="Tipo"
        authority="Autoridad"
        palaceissue="Lugar de emision"
        issuedate="Fecha de asunto"
        expira="Expira"
        passportimginner="passport.jpg"
        opciones="Opciones"
        aprovar="Aprovar"
      />
